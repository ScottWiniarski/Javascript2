    ...
    template: `
        <div class="home page">
            <div class="text-center">
                ...
                <p class="h5 mb-5 text-dark">Don't want to do all the cooking? <span class="text-nowrap">Just tell them to <i>BRING IT!</i></span></p>
            </div>
...
const CreatePotluckPage = Vue.component('CreatePotluckPage', {
    ...
    methods: {
        addPotluck(){
            ...
            thePotluck.datetime = new Date(d[0], d[1]-1, d[2], t[0], t[1], 0);
            ...
            db.collection('potlucks')
                ...
                .then(function(docRef) {
                    ...
                    this.$router.push({ name: 'potluck', params: { id: docRef.id } })
    ...
    template: `
        <div class="create page">
            ...
            <b-form v-if="loggedIn" @submit.prevent="addPotluck">
                <b-form-group label="Name" label-for="name" class="col-md-8 col-lg-6">
                    <b-form-input id="name" v-model="newPotluck.name" required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Date" label-for="date" class="col-md-8 col-lg-6">
                    <b-form-input id="date" v-model="newPotluck.date" type="date" required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Time" label-for="time" class="col-md-8 col-lg-6">
                    <b-form-input id="time" v-model="newPotluck.time" type="time" required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Location" label-for="location" class="col-md-8 col-lg-6">
                    <b-form-input id="location" v-model="newPotluck.location" required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Description" label-for="description" class="col-md-8 col-lg-6">
...
const PotluckPage = Vue.component('PotluckPage', {
    ...
    created(){
        db.collection('potlucks')
            ...
            .get()
            .then(docRef => {
                this.potluck = docRef.data();
                this.potluck.id = docRef.id;
            });
    },
