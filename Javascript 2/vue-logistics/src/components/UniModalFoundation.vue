...
<!--                eslint-disable-next-line vue/no-mutating-props-->
                <uni-modal-details v-for="field in item.material.constructor.fields" :key="field.property" :label="field.label" v-model="item.material[field.property]"></uni-modal-details>
